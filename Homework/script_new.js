...
for (var count = 0; count < 1; count++)
{
    ...
    ctx.lineTo(120,460);
    ctx.stroke();
    ctx.fillText("February", 144, 475);
    ctx.beginPath();
    ctx.moveTo(167,450);
    ctx.lineTo(167,460);
    ctx.stroke();
    ctx.fillText("March", 198, 475);
    ctx.beginPath();
    ctx.moveTo(213,450);
    ctx.lineTo(213,460);
    ctx.stroke();
    ctx.fillText("April", 245, 475);
    ctx.beginPath();
    ctx.moveTo(258,450);
    ctx.lineTo(258,460);
    ctx.stroke();
    ctx.fillText("May", 297, 475);
    ctx.beginPath();
    ctx.moveTo(309,450);
    ctx.lineTo(309,460);
    ctx.stroke();
    ctx.fillText("June", 345, 475);
    ctx.beginPath();
    ctx.moveTo(357,450);
    ctx.lineTo(357,460);
    ctx.stroke();
    ctx.fillText("July", 395, 475);
    ctx.beginPath();
    ctx.moveTo(405,450);
    ctx.lineTo(405,460);
    ctx.stroke();
    ctx.fillText("Augustus", 428, 475);
    ctx.beginPath();
    ctx.moveTo(455,450);
    ctx.lineTo(455,460);
    ctx.stroke();
    ctx.fillText("September", 478, 475);
    ctx.beginPath();
    ctx.moveTo(505,450);
    ctx.lineTo(505,460);
    ctx.stroke();
    ctx.fillText("October", 533, 475);
    ctx.beginPath();
    ctx.moveTo(553,450);
    ctx.lineTo(553,460);
    ctx.stroke();
    ctx.fillText("November", 575, 475);
    ctx.beginPath();
    ctx.moveTo(600,450);
    ctx.lineTo(600,460);
    ctx.stroke();
    ctx.fillText("December", 633, 475);
    ctx.beginPath();
    ctx.moveTo(650,450);
    ctx.lineTo(650,460);
    ctx.stroke();

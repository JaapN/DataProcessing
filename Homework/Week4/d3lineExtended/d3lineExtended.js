// Jaap Nieuwenhuizen
  ...
  var line_wind = d3.svg.line()
      .x(function(d) { return x(formatDate.parse(d.date)); })
      .y(function(d) { return y(+d.windV); });

  var line_cloud = d3.svg.line()
      .x(function(d) { return x(formatDate.parse(d.date)); })
      .y(function(d) { return y(+d.cloudiness); });
  ...
  d3_queue.queue()
    ...
    yDomain_temp = d3.extent(filesAll, function(d) { return +d.temperature; });
    x.domain(xDomain);
    y.domain(yDomain_temp);
    ...
    svg.append('rect')
        ...
        .on('mousemove', function() {
            ...
            focus.select('#focusLineX')
                .attr('x1', xVal).attr('y1', y(yDomain_temp[0]))
                .attr('x2', xVal).attr('y2', y(yDomain_temp[1]));
            ...
            focus.select('#focusLineX2')
                .attr('x1', xVal2).attr('y1', y(yDomain_temp[0]))
                .attr('x2', xVal2).attr('y2', y(yDomain_temp[1]));
  ...
  d3_queue.queue()
    ...
    // define domains
    xDomain = d3.extent(filesAll, function(d) { return formatDate.parse(d.date); });
    yDomain_wind = d3.extent(filesAll, function(d) { return +d.windV; });
    x.domain(xDomain);
    y.domain(yDomain_wind);
    ...
    var points = svg.selectAll(".point")
     ...
     points.append("svg:circle")
        ...
        .attr("fill", function(d, i) { return "white" })
        .attr("cx", function(d, i) { return x(formatDate.parse(d.date)) })
        .attr("cy", function(d, i) { return y(+d.windV) })
        .attr("r", function(d, i) { return 4 })
        .attr("class", "circle");
    ...
    svg.append('rect')
        ...
        .on('mousemove', function() {
            ...
            focus.select('#focusCircle')
                ...
                .attr('cy', yVal);
            focus.select('#focusLineX')
                .attr('x1', xVal).attr('y1', y(yDomain_wind[0]))
                .attr('x2', xVal).attr('y2', y(yDomain_wind[1]));
            focus.select('#focusLineY')
                .attr('x1', x(xDomain[0])).attr('y1', yVal)
                .attr('x2', x(xDomain[1])).attr('y2', yVal);
            ...
            focus.select('#focusCircle2')
                ...
                .attr('cy', yVal2);
            focus.select('#focusLineX2')
                .attr('x1', xVal2).attr('y1', y(yDomain_wind[0]))
                .attr('x2', xVal2).attr('y2', y(yDomain_wind[1]));
            focus.select('#focusLineY2')
                .attr('x1', x(xDomain[0])).attr('y1', yVal2)
                .attr('x2', x(xDomain[1])).attr('y2', yVal2);
  ...
  d3_queue.queue()
    ...
    // define domains
    xDomain = d3.extent(filesAll, function(d) { return formatDate.parse(d.date); });
    yDomain_cloud = d3.extent(filesAll, function(d) { return +d.cloudiness; });
    // yDomain_all = [d3.min(yDomain_temp.concat(yDomain_wind, yDomain_cloud)), d3.max(yDomain_temp.concat(yDomain_wind, yDomain_cloud))];
    x.domain(xDomain);
    y.domain(yDomain_cloud);
    ...
    points.append("svg:circle")
       ...
       .attr("fill", function(d, i) { return "white" })
       .attr("cx", function(d, i) { return x(formatDate.parse(d.date)) })
       .attr("cy", function(d, i) { return y(+d.cloudiness) })
       .attr("r", function(d, i) { return 4 })
       .attr("class", "circle");
   ...
   // focus tracking
    ...
    svg.append('rect')
        ...
        .on('mousemove', function() {
            ...
            var xVal = x(formatDate.parse(d.date));
            var yVal = y(+d.cloudiness);

            focus.select('#focusCircle')
                .attr('cx', xVal)
                .attr('cy', yVal);
            focus.select('#focusLineX')
                .attr('x1', xVal).attr('y1', y(yDomain_cloud[0]))
                .attr('x2', xVal).attr('y2', y(yDomain_cloud[1]));
            focus.select('#focusLineY')
                .attr('x1', x(xDomain[0])).attr('y1', yVal)
                .attr('x2', x(xDomain[1])).attr('y2', yVal);
            ...
            var xVal2 = x(formatDate.parse(d.date));
            var yVal2 = y(+d.cloudiness);

            focus.select('#focusCircle2')
                .attr('cx', xVal2)
                .attr('cy', yVal2);
            focus.select('#focusLineX2')
                .attr('x1', xVal2).attr('y1', y(yDomain_cloud[0]))
                .attr('x2', xVal2).attr('y2', y(yDomain_cloud[1]));
            focus.select('#focusLineY2')
                .attr('x1', x(xDomain[0])).attr('y1', yVal2)
                .attr('x2', x(xDomain[1])).attr('y2', yVal2);
